 ...
 * The template for displaying all manuals with grid layout
 */
...
<main class="site-main">
    <div class="content-area">
        <div class="posts-container full-width">
            ...
            <?php
            // Get all published manual posts
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            $manuals_query = new WP_Query(array(
                'post_type' => 'manual',
                'posts_per_page' => 12,
                'post_status' => 'publish',
                'orderby' => 'date',
            ...
            ?>
                <div class="manuals-page-grid">
                    <?php while ($manuals_query->have_posts()) : $manuals_query->the_post();
                        $post_count++;
