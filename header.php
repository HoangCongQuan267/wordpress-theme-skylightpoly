...
<head>
    ...
    if (is_front_page()) {
        ...
        if (function_exists('get_queried_object')) {
            $category = call_user_func('get_queried_object');
        ...
        if (function_exists('get_queried_object')) {
            $tag = call_user_func('get_queried_object');
        ...
        if (function_exists('get_the_archive_title')) {
            $archive_title = call_user_func('get_the_archive_title');
        }
        if (function_exists('get_the_archive_description')) {
            $archive_description = call_user_func('get_the_archive_description');
        }

        $page_title = $archive_title . ' - ' . get_bloginfo('name');
        $meta_description = $archive_description ? wp_trim_words($archive_description, 25, '...') : 'Lưu trữ tại ' . get_bloginfo('name');
        $canonical_url = get_permalink();
        $og_image = get_theme_mod('site_og_image', get_template_directory_uri() . '/assets/images/og-default.jpg');
    } else {
        $page_title = get_bloginfo('name') . ' - ' . get_bloginfo('description');
